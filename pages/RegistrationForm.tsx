            ...
            <div className="text-center py-10 animate-fade-in">
              <div className="bg-[#2A9D8F] text-white px-8 py-10 rounded-3xl flex flex-col items-center space-y-6 mb-10 shadow-[0_15px_30px_rgba(42,157,143,0.3)]">
                ...
                <div>
                  ...
                  <div className="mt-6 bg-white/20 p-5 rounded-2xl border border-white/20 text-center mx-auto max-w-sm">
                    <span className="bg-white text-[#2A9D8F] text-[8px] font-black px-2 py-0.5 rounded uppercase tracking-widest mb-2 inline-block shadow-sm">Aviso de Entrega</span>
                    <p className="text-base font-semibold leading-relaxed">
                      {settings?.delivery_info_text || 'Sua vaga no estandarte está garantida! Apresente seu 1kg de alimento no ponto de retirada.'}
                    </p>
                  </div>
                </div>
                <button
