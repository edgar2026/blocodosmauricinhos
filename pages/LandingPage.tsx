                ...
                <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
                  ...
                  <div className="text-center md:text-left">
                    ...
                    <div className="space-y-4">
                      <p className="text-gray-700 font-bold text-lg leading-relaxed italic text-center md:text-left">
                        Garanta sua presença e participe da nossa corrente de solidariedade:
                      </p>
                      <ul className="text-gray-600 font-medium text-base space-y-3">
                        ...
                        <li className="flex items-center gap-3">
                          ...
                          <span><strong>Seja um doador solidário:</strong> Contribua com 1kg de alimento e ajude a transformar vidas.</span>
                        </li>
                        <li className="flex items-center gap-3">
                      ...
                      <div className="pt-6 border-t border-blue-50">
                        <div className="bg-[#FFD100]/10 border-l-4 border-[#FFD100] p-4 rounded-r-2xl inline-block w-full">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="bg-[#FFD100] text-[#0041B6] text-[9px] font-black px-2 py-0.5 rounded tracking-widest uppercase">Aviso importante</span>
                          </div>
                          <p className="text-[#0041B6] font-bold text-sm leading-relaxed">
                            {settings?.delivery_info_text || 'A pulseira garante seu acesso completo ao Bloco dos Maurinhos!'}
                          </p>
                        </div>
                      </div>
                    </div>
